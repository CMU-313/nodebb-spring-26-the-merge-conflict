...
module.exports = function (Posts) {
	Posts.getPostSummaryByPids = async function (pids, uid, options) {
		...
		const fields = ['pid', 'tid', 'toPid', 'url', 'content', 'sourceContent', 'uid', 'timestamp', 'deleted', 'upvotes', 'downvotes', 'replies', 'handle', 'isEnglish', 'translatedContent', 'anonymous', 'hasDisallowedContent', 'matchedDisallowedRule'].concat(options.extraFields);
