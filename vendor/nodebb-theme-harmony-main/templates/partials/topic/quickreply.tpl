...
<div component="topic/quickreply/container" class="quick-reply d-flex gap-3 mb-4">
	...
	<form class="flex-grow-1 d-flex flex-column gap-2" method="post" action="{config.relative_path}/compose">
		...
		<div class="quickreply-message position-relative">
			<textarea rows="4" name="content" component="topic/quickreply/text" class="form-control mousetrap" placeholder="temp1"></textarea>
			<div class="imagedrop"><div>[[topic:composer.drag-and-drop-images]]</div></div>
		</div>
		<div>
			<div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-2">
				<label class="form-check-label d-flex align-items-center gap-1 mb-0">
					<input type="checkbox" component="topic/quickreply/anonymous" name="anonymous" value="1" class="form-check-input" />
